      ...
      <div class="col-md-6 col-12 q-pa-md">
        ...
        <q-card-section>
          ...
          <template v-if="unit.unitType === 'rooms'">
            <div v-for="(room, index) in unit.rooms" :key="'room-' + index" class="">
              ...
              <div class="q-mx-none q-mt-md row justify-between">
                ...
                <div class="col-md-7 col-12 q-mb-sm">
                  <!-- <q-btn icon="delete" color="negative" flat round @click="removeRoom(index)" class="q-ml-sm" /> -->
          ...
          <CustomButton label="Add Subunit" color="primary" @click="addRoom" class="q-mb-md"
            :disable="unit.rooms.length >= 3" style="margin-top: auto;"/>
