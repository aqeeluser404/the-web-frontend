  ...
  <q-page>
    ...
    <q-parallax :src="parallax" :height="300" :speed="0.5"
      ...
      <div style="
        ...
        <q-card-section>
          <div class="text-h3 hero-heading">Incident Report</div>
          <br />
          <div class="text-body1 q-mb-lg hero-subheading">Report your incidents</div>
        </q-card-section>
      </div>
    </q-parallax>
    <div style="height: 100%; background-color: #222" class="text-white q-pa-xl">
      <div class="constrain text-center subBanner">
        <div class="text-h4">Please let us know how we can help</div>
      </div>
    </div>
    ...
    <div class="q-pa-lg constrain">
      ...
      <div class="row q-col-gutter-md q-mb-md">
        <div class="col-xs-12 col-sm-6">
          ...
          <q-input filled dense label-color="black" color="black" hide-bottom-space class="bordered-input"
      ...
      <div class="row q-col-gutter-md q-mb-md">
        ...
        <div class="col-xs-12 col-md-4">
          ...
          <q-select filled dense label-color="black" color="black" hide-bottom-space class="bordered-input"
            :options="incidentOptions" v-model="form.incidentNature" />
        </div>

        <!-- Date -->
        <div class="col-xs-12 col-md-4">
          <div class="q-pb-xs">Date (Required)</div>
          <q-input filled dense label-color="black" color="black" hide-bottom-space class="bordered-input" type="date"
            v-model="form.date" />
        </div>
        ...
        <div class="col-xs-12 col-md-4">
          ...
          <div class="row q-col-gutter-md">
            <div class="col-4">
              <q-select filled dense label-color="black" color="black" hide-bottom-space label="Hour"
                :options="hourOptions" class="bordered-input" v-model="form.hour" />
            </div>
            <div class="col-4">
              <q-select filled dense label-color="black" color="black" hide-bottom-space label="Minute"
                :options="minuteOptions" class="bordered-input" v-model="form.minute" />
            </div>
            <div class="col-4">
              <q-select filled dense label-color="black" color="black" hide-bottom-space label="AM/PM"
                :options="['AM', 'PM']" class="bordered-input" v-model="form.period" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="q-mb-md">
        ...
        <q-input filled label-color="black" color="black" hide-bottom-space class="bordered-input" type="textarea"
          rows="6" v-model="form.description" />
      </div>
