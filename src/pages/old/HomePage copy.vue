<template>
  <q-page>
    ...
    <div style="height: 100%;">
      <div flat class="
        ...
        <q-card-section class="text-h3">
          <div @click="openUnitRentals" class="cursor-pointer"><b><span>APPLY NOW</span> FOR 2026
              RESIDENCY</b></div>
        </q-card-section>
        <q-card-section>
    ...
    <!-- Welcome banner -->
    <!----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
    <q-parallax :src="parallax" :speed="0.6" :height="$q.screen.gt.sm ? 600 : 1300"
      :style="`height: ${$q.screen.gt.sm ? 600 : 1400}px; background-position: center 30% !important; background-size: cover !important;`">
      <div style="
          position: absolute;
          top: 0;
          left: 0;
        ...
        <q-card-section class="">
          <div class="text-h3"><b>Modern. Purpose-Built. Perfectly Positioned</b></div>
          <br><br>
          <div class="text-h6">
            ...
            getting around effortless. <br><br>
            ...
            security with advanced access control and CCTV.

            <br><br>
            <span class="text-body1"><em>Choose the lifestyle option that suits you best.</em></span>
          </div>
        </q-card-section>
      </div>
    </q-parallax>
    ...
    <div id="amenities-section" class="row justify-around" style="height: 100%; background-color: #333;">
      <q-card flat class="
        ...
        <q-card-section class="fade-in-scale">
          ...
          <br>
          <div class="text-h3"><b>What's inside The-WEB?</b></div>
          <br>
          <ul class="q-mb-lg custom-list text-h6">
            <li><span class="q-mr-md">⛰</span> 360° panoramic views</li>
      ...
      <div style="margin-top: 0; background-color: #333;" class="col-md-7 col-12 full-height">
        <q-carousel style="background-color: #333;" animated v-model="currentSlide4" infinite autoplay
          ...
          transition-duration="1800" height="600px" control-color="white" class="">
    ...
    <div id="units-section" class="q-py-xl dark-wrapper text-white">
      <div class="full-width text-center">
        <div class="text-h3 q-mb-md"><b>Rooms</b></div>
        <div class="text-h6 q-pa-md">
          We offer elevated room options from larger private rooms at Botmaskop <br> to uniquely designed
          Shoji-separated
          semi-private rooms at Helshoogte, each thoughtfully crafted <br> to meet the diverse needs of modern students.
        </div>
      </div>
        ...
        <div class="row  justify-center constrain">
          <div class="col-md-4 col-12">
            <q-card flat class="text-white q-pa-md text-center q-ma-sm" style="background-color: #222;">
              ...
              <p class="text-body1">Larger private room</p>
            </q-card>
          </div>
          <!-- <div class="col-md-4 col-12">
            <q-card flat class="text-white q-pa-md text-center q-ma-sm" style="background-color: #222;">
          ...
          <div class="col-md-4 col-12">
            <q-card flat class="text-white q-pa-md text-center q-ma-sm" style="background-color: #222;">
              ...
              <p class="text-body1">Shoji separated semi-private room</p>
            </q-card>
          </div>
        </div>
        <div class="text-body1 q-my-lg text-center">
    ...
    <div id="location-section">
      ...
      <q-card flat class="bg-transparent column items-center full-width ">
        <q-card-section class="fade-in-scale">
          <div class="text-h6 text-center">
            <b>⸻&nbsp;&nbsp;&nbsp;LOCATION&nbsp;&nbsp;&nbsp;⸻</b>
          </div>
          <br>
          <div class="text-h3 text-center" style="line-height: 1.25;"><b>Where Campus Meets Lifestyle <br>And Nature
              Meets
              Culture</b></div>
          <br><br>
          <div class="text-h6 text-center q-mb-lg" style="line-height: 1.69;">
            <span class="text-h5"><b>1 Old Helshoogte Road, Idas Valley, Stellenbosch</b></span>
            <br><br>
          ...
          <div class="row justify-between q-mt-lg">
            ...
            <div class="col-md-6 col-12 full-height">
              <div class="text-h4 q-mb-md"><b>Within walking or easy <br> cycling distance</b></div>
              <ul class="q-mb-lg custom-list text-h6">
                ...
                <li>
                  ...
                  <ul class="q-mt-md" style="list-style: disc inside; padding-left: 1.5rem; margin-top: 0.75rem;">
                    <li style="padding-left: 1.5rem;">Outdoor study sessions</li>
                    <li style="padding-left: 1.5rem;">Picnics</li>
                  </ul>
                </li>
            ...
            <div class="col-md-5 col-12 full-height">
              <div class="text-h4 q-mb-md"><b>Weekend escapes</b></div>
          ...
          <div class="row justify-between q-mt-lg">
            <!-- Block 3 -->
            <div class="col-md-6 col-12 full-height">
              <div class="text-h4 q-mb-md"><b>Surrounded by nature and adventure</b></div>
              <div class="text-h6 q-mb-lg">
              ...
              <ul class="q-mb-lg custom-list text-h6">
                ...
                <li>
                  ...
                  <ul class="q-mt-md" style="list-style: disc inside; padding-left: 1.5rem; margin-top: 0.75rem;">
                    <li style="padding-left: 1.5rem;">Mountain biking</li>
                    <li style="padding-left: 1.5rem;">Hiking</li>
                    <li style="padding-left: 1.5rem;">Trail running</li>
                  </ul>
                </li>
                <li>
                  <span class="q-mr-sm">✔️</span> Network of cycling and hiking trails through:
                  <ul class="q-mt-md" style="list-style: disc inside; padding-left: 1.5rem; margin-top: 0.75rem;">
                    <li style="padding-left: 1.5rem;">Pine forests, fynbos, and
                      mountain passes</li>
                    <li style="padding-left: 1.5rem;">Perfect for beginners and advanced riders</li>
                    <li style="padding-left: 1.5rem;">Guided tours available</li>
                  </ul>
                </li>
              </ul>
            </div>
            ...
            <!-- Block 4 -->
            <div class="col-md-5 col-12 full-height">
              <div class="text-h4 q-mb-md"><b>Sporting excellence nearby</b></div>
              <ul class="q-mb-lg custom-list text-h6">
                <li><span class="q-mr-sm">✔️</span>
                  Idas Valley Sports Ground:
                  <ul class="q-mt-md" style="list-style: disc inside; padding-left: 1.5rem; margin-top: 0.75rem;">
                    <li style="padding-left: 1.5rem;">Home to Stellenbosch FC and the Federico</li>
                    <li style="padding-left: 1.5rem;">Coppini Tennis Foundation</li>
                  </ul>
                </li>
                <li><span class="q-mr-sm">✔️</span>
                  Lentelus Sports Ground:
                  <ul class="q-mt-md" style="list-style: disc inside; padding-left: 1.5rem; margin-top: 0.75rem;">
                    <li style="padding-left: 1.5rem;">Historic home of Maties Football Club</li>
                  </ul>
                </li>
          ...
          <div class="text-body1 text-center q-mt-xl">
            ...
            <br>Mountains. Markets. Matches. Moments. It's all right here.</em>
          </div>
        </q-card-section>
      </q-card>
    ...
    <q-parallax :src="parallax2" :speed="1" :height="$q.screen.gt.sm ? 700 : 1200"
      ...
      " class="text-white text-center column justify-center items-center">
        <q-card-section class="constrain q-px-lg" style="max-width: 1024px">
          <div class="text-h4"><b>A New Landmark with Deep Roots</b></div>
          <br><br>
          <div class="text-h6">
          ...
          <br><br>
          <div class="text-h4"><b>A Life Surrounded by Heritage & Nature</b></div>
          <br><br>
          <div class="text-h6">
    ...
    <!-- -----------------------------------------------------------------------------------------------------------------------------------------------  -->
    <div style="height: 120px; background-color: white;"></div>
    <div class="row justify-around overflow-hidden-x" style="height: 100%;">
      <q-card flat class="
        bg-transparent
        text-body1
        q-pa-lg
        ...
        <q-card-section class="fade-in-scale">
          ...
          <br>
          <div class="text-h3"><b>Why Choose The-WEB?</b></div>
          <br>
          <div class="text-h6 q-mb-lg">
          ...
          <div class="text-body1">
            <em>Whether you're first-year or finishing your thesis, The-WEB adapts to <br> your academic rhythm and personal
            style.</em>
          </div>
        </q-card-section>
      </q-card>
      ...
      <q-card flat class="bg-transparent text-white row justify-center constrain">
        ...
        <q-card-section class="col-md-6 col-12">
          ...
          <div class="column">
            ...
            <a href="tel:+27213008801" target="_blank" class="q-mb-md"
              style="color: white; text-decoration: none; ">
              <q-icon name="eva-phone-outline" class="q-mr-sm" /> (+27) 21-300-8801
            </a>
